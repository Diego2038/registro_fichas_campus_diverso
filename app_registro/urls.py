...
urlpatterns = [
    ...
    path('pertenencia_grupo_poblacional/<str:numero_documento>/', PertenenciaGrupoPoblacionalRetrieveUpdateDestroyView.as_view(), name='pertenencia-grupo-poblacional-retrieve-update-destroy'),
]
