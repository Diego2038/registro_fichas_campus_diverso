...
urlpatterns = [
    path('', DiversidadSexualListCreateView.as_view(), name='diversidad-sexual-list-create'),
    path('<str:id_persona>/', DiversidadSexualRetrieveUpdateDestroyView.as_view(), name='diversidad-sexual-retrieve-update-destroy'),
